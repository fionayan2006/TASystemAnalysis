...
observed = BP_TAInGI/avg_size_chromo_bp * 100
observed_absolute = TAInGI/(TAInGI+TANotInGI)*100

observed_ta = BP_TAInGI/total_TA_BP*100
 
print('The number of basepairs of TA in GI = ' + str(BP_TAInGI))
print('The total number of basepairs of TA systems = ' + str(total_TA_BP))
print('observed absolute = ' + str(observed_absolute))
print("Observed_ta = "+ str(observed_ta))
